<div class="col-lg-12">
    <div class="card">
        <div class="card-header align-items-center d-flex">
            <h4 class="card-title mb-0 flex-grow-1">Create New Credit</h4>
        </div>
        <div class="card-body">
            <div class="live-preview">
                <form class="row g-3 needs-validation" novalidate action="{{ route('coins.store') }}" method="post">
                    @csrf
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-label-group in-border">
                            <input type="number" step="0.001"
                                ...
                                name="amount" placeholder="Please enter" value="{{ old('amount') }}">
