...
<a href="{{ route('tournament-enrollments.edit', $row->id) }}"
...
<a href="{{ route('tournament-enrollments.destroy', $row->id) }}" data-rowid="{{ $row->id }}"
    data-table="tournament-enrollments-data-table"
