    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                @endpermission
                @permission('tournament-permission')
                    <li class="nav-item">
                ...
                @endpermission
                @permission('team-enrollment-permission')
                    <li class="nav-item">
                ...
                @endpermission
                @permission('match-scheduler-permission')
                    <li class="nav-item">
                ...
                @endpermission
                @permission('roles-permissions-setup')
                    <li class="nav-item">
