        ...
        <div class="card-body">
            <div class="live-preview">
                <form class="row g-3 needs-validation" novalidate
                    action="{{ route('subscriptions.update', $subscriptionPrice->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="col-md-4">
                        <div class="form-label-group in-border">
                            <input type="number" step="0"
                                ...
                                name="credit" placeholder="Please enter" value="{{ $subscriptionPrice->credit }}"
                                required>
                    ...
                    <div class="col-md-4">
                        <div class="form-label-group in-border">
                            <input type="number" step="0.001"
                                ...
                                value="{{ $subscriptionPrice->no_of_months }}">
