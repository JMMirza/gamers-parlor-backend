    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="live-preview">
                <form class="row g-3 needs-validation" novalidate action="{{ route('platforms.store') }}" method="post" enctype="multipart/form-data" id="blogForm">
                    @csrf
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="form-label-group in-border">
                            <input type="file" class="form-control image" id="log" name="logo" placeholder="logo" value="{{ old('logo') }}">
                    ...
                    <div class="col-12 text-end">
                        ...
                        <a href="{{ route('platforms.index') }}" class="btn btn-light bg-gradient waves-effect waves-light">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
