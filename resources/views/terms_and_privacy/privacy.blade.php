...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h3>Gamers Parlor G.P.</h3>
                <h4>Privacy Policy</h4>
                <p>Effective date: October 4th 2022 <br />
                    Gamers Parlor G.P. ("us", "we", or "our") operates the https://www.gamersparlor.pro website and
                    Gamers Parlor Mobile App(the "Service").<br /><br />
                    ...
                    Conditions, accessible from https://www.gamersparlor.pro
                </p>
                <h4>Definitions</h4>
                <ul>
                    <li>
                        <strong>Service</strong><br /><br />
                        Service is the https://www.gamersparlor.pro website and mobile app operated by Gamers Parlor
                        G.P.<br /><br />
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        the Service infrastructure itself (for example, the duration of a page visit).<br /><br />
                    </li>
                    <li>
                ...
                <h4>Use of Data</h4>
                <p>Gamers Parlor G.P. uses the collected data for various purposes:</p>
                <ul>
                ...
                <br />
                <p>If you are from the European Economic Area (EEA), Gamers Parlor G.P. legal basis for collecting and
                ...
                <br />
                <p>Gamers Parlor G.P. may process your Personal Data because:</p>
                <ul>
                ...
                <p>Gamers Parlor G.P will retain your Personal Data only for as long as is necessary for the purposes
                ...
                <br />
                <p>Gamers Parlor G.P will also retain Usage Data for internal analysis purposes. Usage Data is generally
                ...
                <br />
                <p>Gamers Parlor G.P will take all steps reasonably necessary to ensure that your data is treated
                ...
                <p>If Gamers Parlor G.P is involved in a merger, acquisition or asset sale, your Personal Data may be
                ...
                <p>Under certain circumstances, Gamers Parlor G.P may be required to disclose your Personal Data if
                    required to do so by law or in response to valid requests by public authorities (e.g. a court or a
                    government agency).</p>
                <br />
                <h5>Legal Requirements</h5>
                <p>Gamers Parlor G.P may disclose your Personal Data in the good faith belief that such action is
                    necessary to:</p>
                <br />
                <ul>
                    <li>To comply with a legal obligation</li>
                    <li>To protect and defend the rights or property of Gamers Parlor G.P</li>
                ...
                <p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights.
                    Gamers Parlor G.P aims to take reasonable steps to allow you to correct, amend, delete, or limit the
                ...
                <ul>
                    <li><strong>The right to access, update or to delete the information we have on you</strong>.
                        ...
                        yourself, please contact us to assist you.</li>
                    ...
                    <li><strong>The right to data portability</strong>. You have the right to be provided with a copy of
                        the information we have on you in a structured, machine-readable and commonly used format.</li>
                    <li><strong>The right to withdraw consent</strong>. You also have the right to withdraw your consent
                        at any time where Gamers Parlor G.P relied on your consent to process your personal information.
                    </li>
                </ul>
                ...
                <ul>
                    <li><strong>Google Analytics</strong><br><br>
                ...
                <p>Gamers Parlor G.P uses remarketing services to advertise on third party websites to you after you
                ...
                <ul>
                    <li><strong>Google AdWords</strong><br /><br />
                        Google AdWords remarketing service is provided by Google Inc. <br /><br />
                        ...
                        <a href="http://www.google.com/settings/ads">http://www.google.com/settings/ads</a> <br /><br />
                        ...
                        ability to prevent their data from being collected and used by Google Analytics. <br /><br />
                        For more information on the privacy practices of Google, please visit the Google Privacy & Terms
                        web page:
                        <a
                            href="https://policies.google.com/privacy?hl=en">https://policies.google.com/privacy?hl=en</a>
                    </li>
                    <li><strong>Facebook</strong><br /><br />
                        ...
                        You can learn more about interest-based advertising from Facebook by visiting this page: <a
                            href="https://www.facebook.com/help/164968693837950">https://www.facebook.com/help/164968693837950</a><br /><br />
                        To opt-out from Facebook's interest-based ads follow these instructions from Facebook:
                        https://www.facebook.com/help/568137493302217<br /><br />
                        Facebook adheres to the Self-Regulatory Principles for Online Behavioral Advertising established
                        by the Digital Advertising Alliance. You can also opt-out from Facebook and other participating
                ...
                <ul>
                    <li>By email: support@gamersparlor.pro</li>
                </ul>
            </div>
        </div>
    </div>
